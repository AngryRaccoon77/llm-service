...
# === Путь к модели GGUF ===
model_path = r"D:\model\yandex\YandexGPT-5-Lite-8B-instruct-GGUF\YandexGPT-5-Lite-8B-instruct-Q4_K_M.gguf"
...
system_prompt = (
    ...
    "по имени Стася, работающий на русском языке. Твоя задача — отвечать на вопросы пользователей, "
    ...
    "Учитывай историю разговора для поддержания контекста."
)
